...
var ErrImagePrivateNotAllowed = errors.New("private images not allowed on your plan")
var ErrImageAccountLocked = errors.New("account is locked because usage exceeds current plan limits")
